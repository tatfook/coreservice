...
module.exports = app => {
    ...
    app.model.lessonOrganizations.hasMany(
        app.model.lessonOrganizationPackages,
        {
    ...
    app.model.lessonOrganizationPackages.belongsTo(
        app.model.lessonOrganizations,
        {
            as: 'lessonOrganizations',
            foreignKey: 'organizationId',
            targetKey: 'id',
    ...
    app.model.lessonOrganizations.hasMany(
        app.model.lessonOrganizationClassMembers,
        {
    ...
    app.model.lessonOrganizationClassMembers.belongsTo(
        app.model.lessonOrganizations,
        {
            as: 'lessonOrganizations',
            foreignKey: 'organizationId',
    ...
    app.model.lessonOrganizationClasses.hasMany(
        app.model.lessonOrganizationClassMembers,
        {
            as: 'lessonOrganizationClassMembers',
            foreignKey: 'classId',
    ...
    app.model.lessonOrganizationClassMembers.belongsTo(
        app.model.lessonOrganizationClasses,
        {
    ...
    app.model.lessonOrganizationClassMembers.hasMany(
        app.model.lessonOrganizationPackages,
        {
            as: 'lessonOrganizationPackages',
            foreignKey: 'classId',
    ...
    app.model.lessonOrganizationClasses.hasMany(
        app.model.lessonOrganizationActivateCodes,
        {
    ...
    app.model.lessonOrganizationActivateCodes.belongsTo(
        app.model.lessonOrganizationClasses,
        {
            as: 'lessonOrganizationClasses',
            foreignKey: 'classId',
    ...
    app.model.lessonOrganizationForms.hasMany(
        app.model.lessonOrganizationFormSubmits,
        {
    ...
    app.model.lessonOrganizationFormSubmits.belongsTo(
        app.model.lessonOrganizationForms,
        {
