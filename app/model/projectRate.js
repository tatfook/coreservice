...
module.exports = app => {
    ...
    model.statisticsRate = async function() {
        ...
        // const projectRate = projectRateCount < 8 ? 0 : (projectRateCount / (projectRateCount + rateThreshold) *
        // projectAvgRate + rateThreshold / (projectRateCount + rateThreshold) *projectsAvgRate);
