...
module.exports = app => {
    ...
    model.mergeMessage = async function(userId) {
        ...
        const sql =
            ...
            'select id, createdAt from messages where `all` = :all and createdAt > :createdAt and id not in (select messageId from userMessages where userId = :userId)';
    ...
    model.getCountByUserId = async function(userId) {
        await this.mergeMessage(userId);
    };
