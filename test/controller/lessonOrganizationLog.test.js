...
describe('机构', () => {
    ...
    it('001 机构日志', async () => {
        ...
        const organ = await app.model.lessonOrganizations
            .create({ name: 'org0000', count: 1, endDate: '2119-01-01' })
            .then(o => o.toJSON());
        ...
        await app
            .httpRequest()
            .put('/api/v0/lessonOrganizations/' + organ.id)
            .send({ privilege: 1 })
        ...
        const cls = await app
            .httpRequest()
            .post('/api/v0/lessonOrganizationClasses')
            .send({
                organizationId: organ.id,
                name: 'class000',
                begin: new Date(),
        ...
        await app
            .httpRequest()
            .post('/api/v0/organizations/changepwd')
            .send({
                organizationId: organ.id,
                classId: cls.id,
                memberId: 2,
