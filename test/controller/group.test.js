...
describe('组', () => {
    ...
    it('001 组的增删查改', async () => {
        ...
        await app
            .httpRequest()
            .delete(`/api/v0/groups/${group2.id}`)
            .set('Authorization', `Bearer ${token}`)
            .expect(res => assert(res.statusCode == 200))
            .then(res => res.body);
