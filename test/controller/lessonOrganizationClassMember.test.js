...
describe('机构学生', () => {
    ...
    it('001 机构学生添加接口测试', async () => {
        ...
        let cls = await app.model.lessonOrganizationClasses
            ...
            .then(o => o.toJSON());
        let cls1 = await app.model.lessonOrganizationClasses
            .create({
                name: 'clss001',
                organizationId: organ.id,
                begin: new Date(),
            ...
            .then(o => o.toJSON());
        let cls2 = await app.model.lessonOrganizationClasses
            .create({
                name: 'clss002',
                organizationId: organ.id,
                begin: new Date(),
        ...
        let members = await app
            .httpRequest()
            .post('/api/v0/lessonOrganizationClassMembers')
            .send({
                memberId: 2,
                organizationId: organ.id,
                classIds: [cls.id, cls1.id, cls2.id],
                roleId: 1,
            })
        ...
        await app
            .httpRequest()
            .delete(
                '/api/v0/lessonOrganizationClassMembers/' +
                    members[0].id +
                    '?roleId=2'
            )
            .set('Authorization', `Bearer ${token}`)
